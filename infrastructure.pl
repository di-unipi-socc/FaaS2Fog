...
% node(nodeId, providerId, listOfSupportedSecurityProperties,listOFSoftwareCapabilities, listOFHWcapabilities)
%provider1
node(edge1, provider1, [data_encryption], [python,javascript,java], [(ram, 2048)]).
node(edge2, provider1, [data_encryption, antitampering],    [python, java], [(ram, 800)]).
%provider2
%node(edge3, provider2, [antitampering],                     [javascript, java]).
%node(edge4, provider2, [data_encryption,antitampering],     [python,java]).
%provider3
node(edge5, provider3, [data_encryption,antitampering],     [java], [(ram, 4096)]).
node(edge6, provider3, [wireless_security,antitampering],   [java],[(ram, 8192)]).
